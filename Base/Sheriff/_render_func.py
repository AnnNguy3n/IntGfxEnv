...
def get_state_image(state=None):
    ...
    for i in range(15):
        text = str(temp[i])
        draw_outlined_text(draw, text, params.font28, (s_0+110*i, 702), (255, 255, 255), 1)

    temp = state[382:397].astype(int)
    for i in range(15):
        text = str(temp[i])
        bbox = draw.textbbox((0, 0), text, params.font28)
        draw_outlined_text(draw, text, params.font28, (s_0+110*i+50-bbox[2]//2, 710), (255, 255, 255), 1)

    temp = state[397:412].astype(int)
    for i in range(15):
        text = str(temp[i])
        bbox = draw.textbbox((0, 0), text, params.font28)
        draw_outlined_text(draw, text, params.font28, (s_0+110*i+100-bbox[2], 718), (255, 255, 255), 1)
